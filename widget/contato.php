<div class="main_contato py-5 bg-light text-center">
    <div class="container">
        <h1 class="text-front">Entre Contato com Conosco</h1>
        <p class="mb-0">Quer Conversar com um corretor exclusivo e ter o atendimento diferenciado em buscar do seu imóvel dos sonhos.</p>
        <p>Preenche o formulário abaixo e vamos lhe direcionar para alguém que entende a sua necessidade!</p>
        ...
        <div class="row text-left">
            <form action="">
                ...
                <div class="form-group">
                    <textarea name="teste" rows="5" placeholder="Escrever uma mensagem..." class="form-control"></textarea>
                </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-12 col-md-4">
                ...
                <p><a href="" class="text-front">cursos@upinsider.com.br</a></p>
            </div>
            <div class="col-12 col-md-4">
                <h2 class="icon-phone">Por Telefone</h2>
                <p>Estamos disponíveis no número abaixo no horário comercial</p>
                <p class="text-front py-2">+55 (48) 3322-1234</p>
            </div>
            <div class="col-12 col-md-4">
                <h2 class="icon-phone">Redes Sociais</h2>
